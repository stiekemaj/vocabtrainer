...
var SubjectsController = function($scope, $http) {
    $scope.subject = {};
    ...
    $scope.addNewSubject = function (subject) {
        ...
        $http.post('subjects/add', subject).success(function () {
            $scope.fetchSubjectList();
            $scope.subject.name = '';
            $scope.subject.description = '';
        }).error(function () {
                    $scope.setError('Could not add a new subject');
                });
    }

    $scope.fetchSubjectList = function() {
